...
?>
	...
	<?php if ( jobify_get_the_company_instagram() ) : ?>
	<li><a href="<?php echo esc_url( jobify_get_the_company_instagram() ); ?>" target="_blank" class="job_listing-instagram">
		<?php _e( 'Instagram', 'jobify' ); ?>
	</a></li>
	<?php endif; ?>
