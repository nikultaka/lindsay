...
class Jobify_WP_Job_Manager_Listing extends Jobify_Listing {
	 ...
	 * @return string
	 */
	public function get_the_company_instagram() {
		$company_instagram = $this->get_object()->_company_instagram;

		if ( $company_instagram && filter_var( $company_instagram, FILTER_VALIDATE_URL ) === false ) {
			$company_instagram = 'https://instagram.com/' . $company_instagram;
		}

		return apply_filters( 'the_company_instagram', $company_instagram, $this->get_object() );
	}
	...
	public function get_the_company_linkedin() {
		...
		if ( $company_linkedin && filter_var( $company_linkedin, FILTER_VALIDATE_URL ) === false ) {
			$company_linkedin = 'https://linkedin.com/company/' . $company_linkedin;
		}
