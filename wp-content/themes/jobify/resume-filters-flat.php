...
<form class="resume_search_form resume_search_form--flat" action="<?php echo resume_manager_get_permalink( 'resumes' ) ? resume_manager_get_permalink( 'resumes' ) : get_post_type_archive_link( 'resume' ); ?>" method="GET">
