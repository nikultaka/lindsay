 ...
 */
Class Chives_Switch_Control extends WP_Customize_Control{
	public $type = 'switch';
 ...
 */
Class Chives_Radio_Image_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Chives_Dropdown_Chosen_Control extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="chives-chosen-select" <?php $this->link(); ?>>
                    <?php
 ...
 * @access public
 */
class Chives_Customize_Section_Upsell extends WP_Customize_Section {
